...
const PaymentOptionsMerch = ({ className = '' }) => {
    ...
    <div className={className}>
      <div className="rounded-2xl bg-white p-5 shadow ring-1 ring-black/10">
        ...
        <p className="mt-4 text-l text-black">
          Nota: Vi chiediamo di inserire nella causale del bonifico: nome, cognome, tipo di merch, quota ed taglia.
        </p>
        {/* PayPal Pool */}
...
export default PaymentOptionsMerch;
